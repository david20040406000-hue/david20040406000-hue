<picture>
  ...
  <img src="./assets/profile-light.svg" width="100%" alt="Zhaxia — Code. Adapt. Evolve. 自主決策與演算法；Screeps Empire AI：任務調度、空間規劃與 CPU 預算管理。">
</picture>
...
<sub>原始碼維持私人；此處展示系統架構與演算法方向。</sub>

<details>
<summary>About this profile · 關於這個首頁</summary>

以原創 SVG 製作動畫名片，支援深色、淺色與手機版面。開場文字逐步顯示，搭配以個人炸蝦頭像重新渲染的簡約平面像素圖示、分段顯影與流動線條；啟用系統「減少動態效果」時顯示靜態內容。
